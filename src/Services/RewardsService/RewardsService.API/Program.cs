...
builder.Services.AddDbContext<RewardsDbContext>(opt =>
...
builder.Services.AddScoped<IRewardsService, RewardsDomainService>();
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "WalletPlatform - Rewards API", Version = "v1" });
