...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.Console()
    .WriteTo.File("logs/ledger-.log", rollingInterval: RollingInterval.Day)
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "WalletPlatform - Ledger API", Version = "v1" });
...
app.UseSwagger();
app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Ledger API v1"));
